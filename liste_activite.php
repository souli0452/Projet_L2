...
$id_activite=isset($_POST['valeur'])? $_POST['valeur']:'';
{//recherche
...
{
   $id_activite= $data[0];
   $titre_activite= $data[1];
   $resum_activite= $data[2];
   $date_activite= $data[3];
   $lieu_activite= $data[4];
   $etat_activite= $data[5];
...
<table width="399" border="0" align="center" bordercolor="#060">
  <tr>
   <!--<td>Choix</td>-->
   <td width="64" align="center" bgcolor="#FFCC66">id_activite:</td>
    <td width="45" align="center" bgcolor="#FFCC66">titre activite:</td>
    <td width="115" align="center" bgcolor="#FFCC66">resumé activite:</td>
    <td width="78" align="center" bgcolor="#FFCC66">date activité:</td>
	<td width="94" align="center" bgcolor="#FFCC66">lieu activité:</td>
	<td width="418" align="center" bgcolor="#FFCC66">etat activité:</td>
  </tr>
<?php
{
//connexion au SGBDMysql.
    ...
    <td align="center" bgcolor="#BBBBBB"><?php echo $data[2];?></td>
	 <td align="center" bgcolor="#BBBBBB"><?php echo $data[3];?></td>
	  <td align="center" bgcolor="#BBBBBB"><?php echo $data[4];?></td>
	   <td align="center" bgcolor="#BBBBBB"><?php echo $data[5];?></td>
  </tr>
<?php }
}    
?>
