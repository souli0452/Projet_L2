...
//Insertion
$titre_activite=isset($_POST['titre_activite'])? $_POST['titre_activite']:'';
$resum_activite=isset($_POST['resum_activite'])? $_POST['resum_activite']:'';
$date_activite=isset($_POST['date_activite'])? $_POST['date_activite']:'';
$lieu_activite=isset($_POST['lieu_activite'])? $_POST['lieu_activite']:'';
$etat_activite=isset($_POST['etat_activite'])? $_POST['etat_activite']:'';
$envoyer=isset($_POST['envoyer'])? $_POST['envoyer']:'';
if($envoyer=="envoyer")
{$sql="Insert into activite values('','$titre_activite','$resum_activite','$date_activite','$lieu_activite','$etat_activite')";
mysql_query($sql);
$titre_activite = '';
$resum_activite = '';
$date_activite = '';
...
<table width="342" border="1">
  <tr>
    <td width="148">titre activite</td>
    <td width="178"><input name="titre_activite" type="text"  id="titre_activite"/></td>
  </tr>
  <tr>
    <td>resumé activite</td>
    <td><input name="resum_activite" type="text" id="resum_activite"/></td>
  </tr>
  <tr>
    <td>date activité</td>
    <td><input name="date_activite" type="text" id="date_activite"/></td>
  </tr>
  <tr>
    <td>lieu activité</td>
    <td><input name="lieu_activite" type="text" id="lieu_activite"/></td>
  </tr>
  <tr>
    <td>etat activité</td>
    <td><input name="etat_activite" type="text" id="etat_activite"/></td>
  </tr>
  <tr>
...
<a href="liste_activite.php">Voir la liste des activités.</a>
<br>
