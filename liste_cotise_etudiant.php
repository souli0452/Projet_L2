...
$id_etudiant=isset($_POST['valeur'])? $_POST['valeur']:'';
{//recherche
...
while($data=mysql_fetch_array($req))
{
   ...
   $classe_etudiant= $data[3];
   $filiere_etudiant= $data[4];
}
}
...
<title>Liste_cotise_etudiant</title>
...
<table width="463" border="0" align="center" bordercolor="#060">
  <tr>
   <!--<td>Choix</td>-->
    <td width="69" height="25" align="center" bgcolor="#FFCC66">id_etudiant:</td>
    <td width="84" align="center" bgcolor="#FFCC66">nom_etudiant:</td>
    <td width="104" align="center" bgcolor="#FFCC66">prenom_etudiant:</td>
	<td width="94" align="center" bgcolor="#FFCC66">classe_etudiant:</td>
	<td width="90" align="center" bgcolor="#FFCC66">filiere_etudiant:</td>
  </tr>
<?php
{
//connexion au SGBDMysql.
