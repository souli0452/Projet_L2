...
<?php
$news_id=isset($_POST['valeur'])? $_POST['valeur']:'';
{//recherche
...
<title>Liste_noncotise_etudiant</title>
...
<table width="840" border="0" align="center" bordercolor="#060">
  <tr>
   <!--<td>Choix</td>-->
    <td width="46" align="center" bgcolor="#FFCC66">News:</td>
    <td width="328" align="center" bgcolor="#FFCC66">Titre:</td>
    <td width="452" align="center" bgcolor="#FFCC66">Infos:</td>
  </tr>
<?php
{
...
</form><form action="" method="post" name="ok" id="ok">
<table width="840" border="0" align="center" bordercolor="#060">
  <tr>
   <!--<td>Choix</td>-->
    <td width="46" align="center" bgcolor="#FFCC66">News:</td>
